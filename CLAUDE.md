...
- 검증: `npm run verify:backtest` (390건 — 참조 구현 미러 #1~#58·#69~#77·#81~#112·#113~#133·#141~#145·
  ...
  **#275~#290c**(평가·메모 배선)·**#291~#293**(적대적 리뷰 확정 결함 3건 회귀)).
  ...
  #312b~#312e · 재조정 게이팅 #313b · 분해 항등식 2개 #304b·#304c · 초기 매수 예산 #323~#323c ·
  지문 null≠0 #220b · 레거시 마이그레이션 #215b. **전부 변이 테스트로 실제 검출을 확인**했다
