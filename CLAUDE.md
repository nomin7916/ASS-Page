...
- **목표 기준 2종 — 비중의 분모는 '종목 평가액 합계' **하나로 고정** (⚠️ 회귀 주의 — 분모 선택 부활 금지)**:
  ...
  **예수금·매매차익·누적 분배금은 분모에 넣지 않는다**(현금 잔고에 따라 사용자가 정한 비율이
  ...
  - ⚠️ **비중 합이 100%가 아닌 것의 뜻이 달라졌다** — 1회성 현금 버퍼가 아니라 리밸런싱 **때마다**
    ...
    헐어 더 산다). 오타가 조용히 그렇게 돌면 안 되므로 **엔진이 경고**한다(검증 #107~#107d).
...
- 검증: `npm run verify:backtest` (191건 — 참조 구현 미러 #1~#58·#69~#77·#81~#112·#113~#133·#141~#145 +
  소스 텍스트 가드 #59~#68·#78~#80·#134~#140·#146~#155).
  목표 기준(비중 분모 고정) 관련: 미러 #43·#90~#91b·#106~#107d·#109~#109b·#144~#144b,
  가드 #151~#153 / 확대 시 겹침·팝오버 잘림: 가드 #154·#155.
