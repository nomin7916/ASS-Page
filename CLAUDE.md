...
- 검증: `npm run verify:flow` (160건 — 미러 #1~#26 + **팬/줌 #38~#44b** + **색 #45~#48b** +
  **화살촉 방향 #58~#62d** + 소스 텍스트 가드 #27~#36·**#49~#57c**·**#63~#66b** + JSX 주석 #37).
  ...
  **`sanitizeHexColor`·`readableTextColor`·`normalizeFlowViewport`·`sameFlowViewport`·`fitFlowViewport`·
  `normalizeFlowArrow`·`arrowHeads`** 본문과 **항상 1:1 동기화**할 것. 가드는 영속화 배선을 정규식으로 단언하므로, 실패 시 **먼저
