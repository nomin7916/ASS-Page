...
- **⚠️ 개방 한도는 종목별**(그 종목 단계들의 합)이다 — 여러 종목이 같은 날 발동해도 서로의 몫을 빼앗지
  ...
  `buyFunding:'both'`는 평시에 이미 주머니가 열려 있어 단계 비율이 실효가 없다 → 그 경우 `unlocked`를
  **주머니 전액**으로 기록하고 화면이 "단계 비율 미적용"이라고 밝힌다(숨기면 계산식이 거짓말이 된다).
...
- 검증: `npm run verify:backtest` (367건 — 참조 구현 미러 #1~#58·#69~#77·#81~#112·#113~#133·#141~#145·
  **#157~#226**·**#235~#240**·**#250~#256**(적대적 리뷰 회귀)·**#260~#274**(평가·메모)·
  **#300~#318**(시그널 당일 실행·매도 시그널·재원 3단계·분모 캐스케이드) + 소스 텍스트
  가드 #59~#68·#78~#80·#134~#140·#146~#156·**#227~#234**(#233·#233b·#233c = 시그널 계약)·
  **#241~#249**·**#257~#259c**(#259b·#259c = 계산식 표시·매도 UI)·
