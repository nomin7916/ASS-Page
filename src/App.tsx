            ...
            <div className="chart-container-for-drag p-4 h-[400px] relative select-none">
              ...
              <ResponsiveContainer width="100%" height="100%">
                <ComposedChart data={finalChartData} onMouseDown={handleChartMouseDown} onMouseMove={handleChartMouseMove} onMouseUp={handleChartMouseUp} onMouseLeave={handleChartMouseUp}>
                  ...
                  {showIndicatorsInChart.us10y && indicatorHistoryMap.us10y && <YAxis yAxisId="right-us10y" orientation="right" stroke="#8e8e93" tick={{ fontSize: 9 }} tickFormatter={v => Number(v).toFixed(2)} width={52} domain={(() => { const vs = finalChartData.map(d => d.us10yPoint).filter(v => v != null); if (!vs.length) return ['auto','auto']; const mn=Math.min(...vs),mx=Math.max(...vs),p=Math.abs(mx-mn)*0.001||0.01; return [mn-p,mx+p]; })()}><Label value="US 10Y" angle={90} position="insideRight" offset={14} style={{ textAnchor: 'middle', fill: '#8e8e93', fontSize: 11, fontWeight: 500 }} /></YAxis>}
                  {showIndicatorsInChart.goldIntl && indicatorHistoryMap.goldIntl && <YAxis yAxisId="right-goldIntl" orientation="right" stroke="#ffd60a" tick={{ fontSize: 9 }} tickFormatter={v => Math.round(v).toLocaleString()} width={56} domain={(() => { const vs = finalChartData.map(d => d.goldIntlPoint).filter(v => v != null); if (!vs.length) return ['auto','auto']; const mn=Math.min(...vs),mx=Math.max(...vs),p=Math.abs(mx-mn)*0.001||0.1; return [mn-p,mx+p]; })()}><Label value="Gold" angle={90} position="insideRight" offset={14} style={{ textAnchor: 'middle', fill: '#ffd60a', fontSize: 11, fontWeight: 500 }} /></YAxis>}
                  {showIndicatorsInChart.usdkrw && indicatorHistoryMap.usdkrw && <YAxis yAxisId="right-usdkrw" orientation="right" stroke="#0a84ff" tick={{ fontSize: 9 }} tickFormatter={v => Math.round(v).toLocaleString()} width={56} domain={(() => { const vs = finalChartData.map(d => d.usdkrwPoint).filter(v => v != null); if (!vs.length) return ['auto','auto']; const mn=Math.min(...vs),mx=Math.max(...vs),p=Math.abs(mx-mn)*0.001||0.1; return [mn-p,mx+p]; })()}><Label value="USD/KRW" angle={90} position="insideRight" offset={14} style={{ textAnchor: 'middle', fill: '#0a84ff', fontSize: 11, fontWeight: 500 }} /></YAxis>}
                  {showIndicatorsInChart.dxy && indicatorHistoryMap.dxy && <YAxis yAxisId="right-dxy" orientation="right" stroke="#5ac8fa" tick={{ fontSize: 9 }} tickFormatter={v => Number(v).toFixed(1)} width={52} domain={(() => { const vs = finalChartData.map(d => d.dxyPoint).filter(v => v != null); if (!vs.length) return ['auto','auto']; const mn=Math.min(...vs),mx=Math.max(...vs),p=Math.abs(mx-mn)*0.001||0.05; return [mn-p,mx+p]; })()}><Label value="DXY" angle={90} position="insideRight" offset={14} style={{ textAnchor: 'middle', fill: '#5ac8fa', fontSize: 11, fontWeight: 500 }} /></YAxis>}
                  {showIndicatorsInChart.fedRate && indicatorHistoryMap.fedRate && <YAxis yAxisId="right-fedRate" orientation="right" stroke="#ff375f" tick={{ fontSize: 9 }} tickFormatter={v => Number(v).toFixed(2)+'%'} width={54} domain={(() => { const vs = finalChartData.map(d => d.fedRatePoint).filter(v => v != null); if (!vs.length) return ['auto','auto']; const mn=Math.min(...vs),mx=Math.max(...vs),p=Math.abs(mx-mn)*0.001||0.01; return [mn-p,mx+p]; })()}><Label value="기준금리" angle={90} position="insideRight" offset={14} style={{ textAnchor: 'middle', fill: '#ff375f', fontSize: 11, fontWeight: 500 }} /></YAxis>}
                  {showIndicatorsInChart.kr10y && indicatorHistoryMap.kr10y && <YAxis yAxisId="right-kr10y" orientation="right" stroke="#636366" tick={{ fontSize: 9 }} tickFormatter={v => Number(v).toFixed(2)+'%'} width={52} domain={(() => { const vs = finalChartData.map(d => d.kr10yPoint).filter(v => v != null); if (!vs.length) return ['auto','auto']; const mn=Math.min(...vs),mx=Math.max(...vs),p=Math.abs(mx-mn)*0.001||0.01; return [mn-p,mx+p]; })()}><Label value="KR 10Y" angle={90} position="insideRight" offset={14} style={{ textAnchor: 'middle', fill: '#636366', fontSize: 11, fontWeight: 500 }} /></YAxis>}
                  {showIndicatorsInChart.vix && indicatorHistoryMap.vix && <YAxis yAxisId="right-vix" orientation="right" stroke="#ff453a" tick={{ fontSize: 9 }} tickFormatter={v => Number(v).toFixed(1)} width={48} domain={(() => { const vs = finalChartData.map(d => d.vixPoint).filter(v => v != null); if (!vs.length) return ['auto','auto']; const mn=Math.min(...vs),mx=Math.max(...vs),p=Math.abs(mx-mn)*0.001||0.1; return [mn-p,mx+p]; })()}><Label value="VIX" angle={90} position="insideRight" offset={14} style={{ textAnchor: 'middle', fill: '#ff453a', fontSize: 11, fontWeight: 500 }} /></YAxis>}
                  ...
                  {compStocks[0]?.active && <Line yAxisId="left" type="monotone" dataKey="comp1Rate" name={compStocks[0].name} stroke="#b5179e" strokeWidth={1.5} dot={false} />}
                  {compStocks[1]?.active && <Line yAxisId="left" type="monotone" dataKey="comp2Rate" name={compStocks[1].name} stroke="#39ff14" strokeWidth={1.5} dot={false} />}
                  {compStocks[2]?.active && <Line yAxisId="left" type="monotone" dataKey="comp3Rate" name={compStocks[2].name} stroke="#00ffff" strokeWidth={1.5} dot={false} />}
