...
const Header = ({ title, setTitle, isLoading, driveStatus, customLinks, setCustomLinks, onRefresh, onSave, onDriveSave, onLoad, onPaste, onImportHistory, isLinkSettingsOpen, setIsLinkSettingsOpen, fileInputRef, historyInputRef, onDriveConnect, onDriveLoad }) => (
